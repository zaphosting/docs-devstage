...
Puoi trovare il tuo SteamID64 andando sul tuo profilo Steam e cliccando con il tasto destro in un punto qualsiasi. Poi clicca su **Copia URL Steam**. 
...
Il livello di permesso è un valore tra 0 e 1000 che determina quali permessi ha un giocatore. 1000 è il più basso (nessun permesso) e 0 è il più alto (permessi admin completi). Devi regolarlo in base a come vuoi gestire i permessi. 
