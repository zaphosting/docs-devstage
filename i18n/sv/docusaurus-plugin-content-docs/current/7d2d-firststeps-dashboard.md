...
<YouTube videoId="VS24IPMjtxk" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/mL3iTqtoWcP7aCT/preview" title="Setup 7D2D server in just a MINUTE!" description="Känns det lättare att förstå när du ser saker i praktiken? Vi fixar det! Dyka ner i vår video som förklarar allt. Oavsett om du har bråttom eller bara vill ta in info på det mest engagerande sättet!"/>
...
Genom att klicka på bilden kan du skapa din egen spelserverbutik med Tebex. Setupen är snabb och enkel, så du är redo att börja sälja dina virtuella varor på nolltid.
...
**FileZilla:**  FileZilla är den enklaste och mest kända FTP-klienten. Installera bara, starta och skriv in dina inloggningsuppgifter i övre fältet som du hittar lite längre upp på denna sida. Efter ett snabbt klick på "Connect" är du direkt inloggad på servern och kan hantera filerna.
...
Vi erbjuder 10 GB lagringsutrymme på lagringsservern för backuper för våra spelserverprodukter som standard. Om du behöver mer utrymme kan detta uppgraderas mot en avgift. På så sätt säkerställer du att du alltid har tillräckligt med plats för dina backuper och kan fortfarande komma åt äldre backuper vid behov.
