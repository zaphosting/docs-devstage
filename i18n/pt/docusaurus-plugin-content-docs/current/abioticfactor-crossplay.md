...
title: "Abiotic Factor: Configure o Suporte a Crossplay e Saiba Como Conectar via Console"
...
Com a grande atualização **"Cold Fusion" (Versão 1.0)** lançada em **22 de julho de 2025**, **Abiotic Factor** agora suporta oficialmente crossplay. Jogadores no **PC (Steam)**, **PlayStation 5** e **Xbox Series X/S** podem se juntar e explorar as profundezas da instalação de pesquisa juntos, independentemente da plataforma.
...
Com esses passos, você já sabe como gerenciar as configurações de Crossplay e conectar ao seu servidor a partir de um console. Seja jogando no PC ou no console, ativar o Crossplay e usar o método correto de conexão garante uma experiência fluida e compartilhada entre plataformas.

Se tiver mais dúvidas ou precisar de ajuda, não hesite em contatar nosso time de suporte, disponível todos os dias para te ajudar! 🙂
