...
Swoje SteamID64 znajdziesz, wchodząc na swój profil Steam i klikając prawym przyciskiem myszy w dowolnym miejscu profilu. Następnie kliknij **Kopiuj adres URL Steam**. 
...
Dzięki temu uzyskasz ogólne informacje oraz Steam ID swojego konta. W tym przypadku potrzebujemy tylko SteamID64. SteamID64 wpisujesz w sekcji ``<admins>...</admins>``. Wygląda to tak:
...
Gra pozwala na definiowanie różnych poziomów uprawnień administratora. Oznacza to, że możesz stworzyć różne grupy adminów z różnymi uprawnieniami. Poziom definiuje opcja ``permission_level``, którą można ustawić od 0 do 1000. W zależności od konfiguracji, administratorzy mają dostęp do przypisanych uprawnień. Po wykonaniu tych kroków uprawnienia administratora zostaną poprawnie przydzielone. 
