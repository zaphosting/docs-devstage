...
## 介绍
分配管理员权限让你可以轻松且全面地管理服务器，拥有完全控制权。作为管理员，你可以直接在游戏内使用游戏提供的所有可用选项和功能。下面将详细介绍为你的服务器分配管理员权限的所有步骤。 
<InlineVoucher />
...
你可以通过访问你的Steam个人资料并在页面任意位置右键点击，选择 **复制Steam链接** 来获取你的SteamID64。

![](https://screensaver01.zap-hosting.com/index.php/s/Q9WJ8GwbHCmTRPx/preview)



然后打开以下任意网站，将你的个人资料链接粘贴进去：

- https://steamrep.com/
- https://steamidfinder.com/
- https://steamid.io/

这些网站会提供你的账户相关信息，包括Steam ID。这里我们只需要SteamID64。SteamID64需要写在 ``<admins>...</admins>`` 标签内，格式如下：
...
:::danger  管理员记录无法识别？ 
确保移除注释符号 `<!--` 和 `-->`，否则该行会被当作注释忽略，不会生效。只需删除行首和行尾的注释符号即可激活该行。
:::
