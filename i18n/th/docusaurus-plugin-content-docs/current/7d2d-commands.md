...
## คอนโซล
ในการรันคำสั่งบนเซิร์ฟเวอร์เกมของคุณ คุณต้องเป็นแอดมินก่อน ถ้าคุณไม่รู้วิธีเป็นแอดมิน ลองดูคู่มือของเราได้เลย
คำสั่งทั้งหมดต้องรันผ่านคอนโซลของนักพัฒนา คุณสามารถเปิดได้โดยกด `F1`
...
| คำสั่ง    | คำอธิบาย                                                 |
| ----------------- | ------------------------------------------------------------ |
| giveself [item id] [quality level 1-6] | เพิ่มไอเท็มให้ตัวเอง โดยกำหนดระดับคุณภาพที่เลือก |
| debugmenu on/off | เปิด/ปิดเมนูดีบัก สามารถเปิดได้โดยกด G |
| giveselfxp [amount] | เพิ่มคะแนน XP ให้ตัวละครของคุณ |
| creativemenu on/off | เปิด/ปิดเมนูสร้างสรรค์ สามารถเปิดได้โดยกด U |
| spawnsupplycrate | สปอนซัพพลายเครตที่ตำแหน่งของคุณ |
| admin [add] [remove] [list] | ใช้เพิ่ม/ลบแอดมิน |
| kick [playername] [เหตุผล] | เตะผู้เล่นออกจากเซิร์ฟเวอร์เกม |
