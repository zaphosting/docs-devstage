...
## คอนโซล
ถ้าจะรันคำสั่งบนเซิร์ฟเวอร์เกมของคุณ คุณต้องเป็นแอดมินก่อน ถ้าไม่รู้ว่าจะเป็นแอดมินยังไง ลองดูคู่มือของเราได้เลย
คำสั่งทั้งหมดต้องรันผ่านคอนโซลของนักพัฒนา คุณเปิดได้โดยกด `F1`
...
| คำสั่ง    | คำอธิบาย                                                 |
| ----------------- | ------------------------------------------------------------ |
| giveself [item id] [quality level 1-6] | เพิ่มไอเท็มให้ตัวเอง โดยเลือกระดับคุณภาพได้ |
